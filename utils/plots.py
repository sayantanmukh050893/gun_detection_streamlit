...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=2, font='Calibri.ttf', pil=False, example='abc'):
        ...
        if self.pil:  # use PIL
            ...
            self.font = check_pil_font(font='Calibri.Unicode.ttf' if non_ascii else font,
